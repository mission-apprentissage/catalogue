      ...
      <Container className="mt-5">
        <Row>
          <Col xs="12" className="mission-summary">
            <h2 className="mt-3 mb-3">Guide réglementaire</h2>
            <br />
            <h5>
            ...
            <ul>
              ...
              <li className="mt-4">
                <span className="underline">Peuvent intégrer</span> la plateforme Parcoursup sous réserve de
                vérifications/ validations de la part des référents en académie
                <ul>
                  <li>
                    toutes les formations en apprentissage pour les établissements privés ni sous contrat ni EESPIG qui
              ...
              <li className="mt-4">
                <span className="underline">Ne peuvent intégrer</span> la plateforme Parcoursup les formations ne
