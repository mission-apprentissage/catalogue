...
class EsSupApi {
  ...
  async getNumAcademieInfoFromNomAcademie(nomAcademie) {
    try {
      ...
      logger.error(`No data found for ${nomAcademie}`);
      return null;
    } catch (error) {
      logger.error(error);
      return null;
  ...
  async getNomAcademieInfoFromNumAcademie(numAcademie) {
    try {
      ...
      logger.error(`No data found for ${numAcademie}`);
      return null;
    } catch (error) {
      logger.error(error);
      return null;
  ...
  async getNomAcademieInfoFromNumDepartement(numDepartement) {
    try {
      ...
      logger.error(`No data found for ${numDepartement}`);
      return null;
    } catch (error) {
      logger.error(error);
      return null;
  ...
  async getNumAcademieInfoFromCodeCommune(codeCommune) {
    try {
      ...
      logger.error(`No data found for ${codeCommune}`);
      return null;
    } catch (error) {
      logger.error(error);
      return null;
